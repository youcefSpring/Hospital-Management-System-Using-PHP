...
if (isset($_POST['submit'])) {
  ...
  if ($query) {
    echo '<script>alert("historique des médicaments a été ajouté.")</script>';
...
<head>
  <title>Docteur | Gérer les patients</title>
      ...
      <div class="main-content">
        <div class="wrap-content container" id="container">
          ...
          <section id="page-title">
            <div class="row">
              <div class="col-sm-8">
                <h1 class="mainTitle">Docteur | Gérer les patients</h1>
              </div>
              <ol class="breadcrumb">
                <li>
                  <span>Médecin</span>
          ...
          <div class="container-fluid container-fullw bg-white">
            <div class="row">
              <div class="col-md-12">
                <h5 class="over-title margin-bottom-15">Gérer <span class="text-bold">Les patients</span></h5>
                <?php
                $vid = $_GET['viewid'];
