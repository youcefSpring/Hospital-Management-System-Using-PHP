	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				<a href="../index.html">
					<h2> HMS | Mot de passe de réinitialisation du patient</h2>
				</a>
			</div>
			...
			<div class="box-login">
				<form class="form-login" name="passwordreset" method="post" onSubmit="return valid();">
					<fieldset>
						<legend>
							Mot de passe de réinitialisation du patient
						</legend>
						<p>
						...
						<div class="form-actions">
							...
							<button type="submit" class="btn btn-primary pull-right" name="changer">
								Changement <i class="fa fa-arrow-circle-right"></i>
							</button>
						</div>
