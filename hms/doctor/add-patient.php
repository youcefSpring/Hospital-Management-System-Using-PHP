...
<head>
	<title>Doctor | Ajouter Patient</title>
											...
											<div class="panel-body">
												<form role="form" name="" method="post">
													...
													<div class="form-group">
														...
														<input type="email" id="patemail" name="patemail" class="form-control" placeholder="Entrez l'adresse e-mail du patient" required="true" onBlur="userAvailability ()">
													...
													<div class="form-group">
														...
														<textarea name="pataddress" class="form-control" placeholder="Entrez l'adresse du patient" required="true"> </textarea>
													</div>
													<div class="form-group">
														<label for="fess">
															Âge du patient
													...
													<div class="form-group">
														...
														<textarea type="text" name="medhis" class="form-control" placeholder="Saisir les antécédents médicaux du patient (le cas échéant)" required="true"> </textarea>
													</div>
