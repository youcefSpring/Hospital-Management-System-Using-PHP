...
<head>
	<title> Agents | Antécédents médicaux </title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Agents | Antécédents médicaux</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Agents</span>
					...
					<div class="container-fluid container-fullw bg-white">
						<div class="row">
							<div class="col-md-12">
								<h5 class="over-title margin-bottom-15">Agents <span class="text-bold">Antécédents médicaux</span></h5>
								<?php
								$vid = $_GET['viewid'];
