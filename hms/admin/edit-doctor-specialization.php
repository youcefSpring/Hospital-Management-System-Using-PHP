...
<head>
	<title>Assistant | Modifier Spécialisation du Médecin</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Assistant | Modifier Specialisation du Médecin</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Assistant</span>
								...
								<li class="active">
									<span>Modifier Spécialisation du Médecin</span>
								</li>
							</ol>
						</div>
					</section>
									...
									<div class="col-lg-6 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">Modifier Specialisation du Médecin</h5>
											</div>
												...
												<form role="form" name="dcotorspcl" method="post">
													<div class="form-group">
														<label for="exampleInputEmail1">
															Modifier Specialisation du Médecin
														</label>
