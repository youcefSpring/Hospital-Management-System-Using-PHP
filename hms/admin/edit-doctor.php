...
<head>
	<title>Assistant | Modifier les détails du médecin</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Assistant | Modifier les détails du médecin</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Assistant</span>
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">Modifier les Infos du Médecin</h5>
											</div>
