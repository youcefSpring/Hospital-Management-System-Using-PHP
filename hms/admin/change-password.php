...
<head>
	<title>admin | Modifier Mot de Passe </title>
	<meta charset="utf-8" />
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Assistant | Modifer le Mot de passe</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Assistant</span>
								...
								<li class="active">
									<span>Modifer le mot de passe</span>
								</li>
							</ol>
						</div>
					</section>
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">Modifer le Mot de Passe</h5>
											</div>
