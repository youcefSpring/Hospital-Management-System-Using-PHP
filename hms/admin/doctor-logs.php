...
<head>
	<title>admin | Log de session du médecin</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">admin | Log de session du médecin</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>admin </span>
								...
								<li class="active">
									<span>Log de session du médecin</span>
								</li>
							</ol>
						</div>
					</section>
								...
								<table class="table table-hover" id="sample-table-1">
									<thead>
										<tr>
											...
											<th>User IP</th>
											<th>Temps du Login </th>
											<th>Temps du Logout </th>
											<th> Status </th>
