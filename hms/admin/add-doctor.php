...
<head>
	<title>Assistant | Ajouter un médecin</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Assistant | Ajouter un médecin</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Assistant</span>
											...
											<div class="panel-body">
												...
												<form role="form" name="adddoc" method="post" onSubmit="return valid();">
													...
													<div class="form-group">
														...
														<input type="text" name="docname" class="form-control" placeholder="Entrez le nom du médecin" required="true">
													</div>


													<div class="form-group">
														<label for="address">
															Adresse de la clinique médicale
														</label>
														<textarea name="clinicaddress" class="form-control" placeholder="Entrez l'adresse de la clinique médicale" required="true"></textarea>
													</div>
													<div class="form-group">
														<label for="fess">
