...
<head>
	<title>Agent | Editer le profil</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Agent | Editer le profil</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Agent </span>
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											...
											<div class="panel-body">
												...
												?>
													<h4>Profil de : <?php echo htmlentities($data['fullName']); ?> </h4>
													...
													<form role="form" name="edit" method="post">
														...
														<div class="form-group">
															...
															<a href="change-emaild.php">Mettez à jour votre adresse e-mail</a>
														</div>
